...
class TemperaturaViewController: UIViewController {
    ...
    var contato:Contato?
    let URL_BASE = "https://api.openweathermap.org/data/2.5/weather?appid=aff64c0d376163b4a950f1db0593ae92&units=metric"
    let URL_BASE_IMAGE = "https://api.openweathermap.org/img/w/"
